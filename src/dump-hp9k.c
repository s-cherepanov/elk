/* Dump for the HP-PA.  It needs some work; for instance, it currently
 * assumes that the data space is the last space in the a.out file.
 * If it weren't the last space, the code would have to adjust pointers
 * (such as header.space_location) that point into spaces beyond the
 * data space, as the data space in the new a.out is larger than that
